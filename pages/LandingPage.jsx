...
const LandingPage = ({ role }) => {
  ...
  const [hasFetched, setHasFetched] = useState(false);
    ...
    return (
      <Layout>
        <div className="container mx-auto w-72 pl-40 lg:flex pt-32 justify-center items-center">  
            <div class="flex" >
            
                <div class="flex flex-col w-full mr-24">
            ...
            <img src="images/RAM.jpeg" alt="" />
              Item 4
                ...
                {/* <div className="float-right">
                  ...
                  {console.log(data)}
                  {(
                  user.RoleName === 'Manager' || user.RoleName === 'Admin' ? <ManagerTable data={data}  /> : <EmployeeTable data={data} />
                  )}
                </div>             
                  </div>  */}
                  ...
                  <div className="float-right">
                    <div className="relative sm:rounded-lg">
                      ...
                      {user.RoleName === 'Manager' || user.RoleName === 'Admin' ? (
                        ...
                        user.RoleName === 'Employee' ? <EmployeeTable data={data} /> : null
                      )}
                    </div>
                  </div>
