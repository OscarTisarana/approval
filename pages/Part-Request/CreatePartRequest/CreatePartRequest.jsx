...
const CreatePartRequest = () => {
    ...
    const CreatePartRequestAction = (e) => {
        ...
        if(dataTable.length === 0){
          ...
          axios.post(`${PART_SERVICE_BASE_URL}part_request/create`, payload)
          .then((r) => {
              console.log(r)
              if (r.status === 200) {
                setShowSuccess(true);
      ...
      <Layout>
        ...
        <div className="container md:pl-40 flex lg:flex-row flex-col pt-32 justify-center">  
          <div className="lg:basis-1/3 pl-3">
            <form name="create-part-request" onSubmit={(e) => {CreatePartRequestAction(e)}}>           
                <h1 className="text-3xl font-bold mb-4 text-start">Create Part Request</h1>
